...
class ProductsController extends Controller
{
    ...
    public function getIndex(Request $request) {
        ...
        return view('backend.layout.page.products.index',$data);
    }
    public function getAdd() {
        $data['title'] = 'Add Products';

        return view('backend.layout.page.products.add',$data);
    }
    ...
    public function getEdit($id) {
        ...
        return view('backend.layout.page.products.edit',$data);
    }
    ...
    public function getDetail($id) {
        ...
        return view('backend.layout.page.products.detail',$data);
    }
